    ...
    <div class="style-section mb-5">
        ...
        <div class="swiper style1-swiper">
            <div class="swiper-wrapper">
                ...
                <?php $__currentLoopData = $style1Files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <div class="project-slide">
                            <img src="<?php echo e(asset('img/style/1/'.basename($file))); ?>" 
    ...
    <div class="style-section mb-5">
        ...
        <div class="swiper style2-swiper">
            <div class="swiper-wrapper">
                ...
                <?php $__currentLoopData = $style2Files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <div class="project-slide">
                            <img src="<?php echo e(asset('img/style/2/'.basename($file))); ?>" 
    ...
    <div class="style-section">
        ...
        <div class="swiper style3-swiper">
            <div class="swiper-wrapper">
                ...
                <?php $__currentLoopData = $style3Files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <div class="project-slide">
                            <img src="<?php echo e(asset('img/style/3/'.basename($file))); ?>" 
...
<?php /**PATH C:\OSPanel\domains\stroybts\resources\views/sections/projects-gallery.blade.php ENDPATH**/ ?>