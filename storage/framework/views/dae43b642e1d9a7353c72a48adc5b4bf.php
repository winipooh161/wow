                    ...
                    <div class="col-md-4 d-none d-md-block">
                        <div class="quiz-image-container h-100" aria-hidden="true">
                            <div class="quiz-step-image active" data-step="1">
                                <img src="<?php echo e(asset('img/quiz/quiz-step1.webp')); ?>" alt="" class="img-fluid h-100 w-100 object-fit-cover">
                            ...
                            <div class="quiz-step-image" data-step="2">
                                <img src="<?php echo e(asset('img/quiz/quiz-step2.webp')); ?>" alt="Площадь помещения" class="img-fluid h-100 w-100 object-fit-cover">
                                <div class="image-overlay">
                                    <h3>Шаг 2</h3>
                            ...
                            <div class="quiz-step-image" data-step="3">
                                <img src="<?php echo e(asset('img/quiz/quiz-step3.webp')); ?>" alt="Стиль интерьера" class="img-fluid h-100 w-100 object-fit-cover">
                                <div class="image-overlay">
                                    <h3>Шаг 3</h3>
                            ...
                            <div class="quiz-step-image" data-step="4">
                                <img src="<?php echo e(asset('img/quiz/quiz-step4.webp')); ?>" alt="Контактные данные" class="img-fluid h-100 w-100 object-fit-cover">
                                <div class="image-overlay">
                                    <h3>Шаг 4</h3>
                                            ...
                                            <div class="form-check card p-md-3 p-2 h-100 mobile-card">
                                                ...
                                                <label class="form-check-label w-100" for="style_type1">
                                                    <div class="style-preview mb-md-3 mb-1">
                                                        <img src="<?php echo e(asset('img/style/1/style_1.webp')); ?>" alt="Стиль 1" class="img-fluid rounded">
                                                    </div>
                                        ...
                                        <div class="col-6 mb-2">
                                            <div class="form-check card p-md-3 p-2 h-100 mobile-card">
                                                ...
                                                <label class="form-check-label w-100" for="style_type2">
                                                    <div class="style-preview mb-md-3 mb-1">
                                                        <img src="<?php echo e(asset('img/style/2/style_2.webp')); ?>" alt="Стиль 2" class="img-fluid rounded">
                                                    </div>
                                        ...
                                        <div class="col-6 mb-2">
                                            <div class="form-check card p-md-3 p-2 h-100 mobile-card">
                                                ...
                                                <label class="form-check-label w-100" for="style_type3">
                                                    <div class="style-preview mb-md-3 mb-1">
                                                        <img src="<?php echo e(asset('img/style/3/style_3.webp')); ?>" alt="Стиль 3" class="img-fluid rounded">
                                                    </div>
...
<?php /**PATH C:\OSPanel\domains\stroybts\resources\views/sections/quiz-modal.blade.php ENDPATH**/ ?>