...
<head>
    ...
    <title>@yield('title', config('app.name', 'Ремонт квартир в Батайске | Отделочные работы | ЮгСтиль Батайск'))</title>
    <meta name="description" content="@yield('meta_description', 'Ремонт квартир в Батайске под ключ, отделочные работы любой сложности. Профессиональный ремонт по доступным ценам с гарантией качества. Звоните: +7 904 448 2283')">
    <meta name="keywords" content="@yield('meta_keywords', 'ремонт квартир, отделка, ремонтные работы, отделочные работы, ремонт квартир под ключ, ремонт квартир в Батайске, ремонт квартир в Ростове, услуги ремонта квартир')">
    ...
    <meta property="og:title" content="@yield('title', config('app.name', 'Ремонт квартир в Батайске | Отделочные работы | ЮгСтиль Батайск'))">
    <meta property="og:description" content="@yield('meta_description', 'Ремонт квартир в Батайске под ключ, отделочные работы любой сложности. Профессиональный ремонт по доступным ценам с гарантией качества.')">
    <meta property="og:image" content="@yield('meta_image', asset('images/og-image.webp'))">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="@yield('title', config('app.name', 'Ремонт квартир в Батайске | Отделочные работы | ЮгСтиль Батайск'))">
    <meta property="twitter:description" content="@yield('meta_description', 'Ремонт квартир в Батайске под ключ, отделочные работы любой сложности. Профессиональный ремонт по доступным ценам с гарантией качества.')">
    <meta property="twitter:image" content="@yield('meta_image', asset('images/og-image.webp'))">
...
Батайск, Ростовская область</li>
                            <li class="mb-2"><i class="bi bi-clock-fill text-primary me-2"></i> {{ $contactInfo['working_hours'] }}</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-4 pt-3 border-top border-secondary">
                    <div class="col-12 text-center">
                        <p class="mb-0">&copy; {{ date('Y') }} ЮгСтиль Батайск - Ремонт квартир и отделочные работы. Все права защищены.</p>
                    </div>
                </div>
            </div>
        </footer>
        ...
        @include('sections.quiz-modal')
    </div>
    
    <!-- Контроль доступности -->
    @include('sections.accessibility-controls')
